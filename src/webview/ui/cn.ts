...
const merge = extendTailwindMerge({ extend: { theme: {
  text: ['1', '2', '3', 'mono'],
  spacing: ['row', 'row-dense', 'ctl', 'ctl-sm', 'lead', 'icon', 'icon-ctl', 'pad', 'pad-y', 'page', 'gap', 'msg', 'hdr', 'thumb', 'indent', 'hit', 'term', 'pop', 'plan', 'question-body', 'pop-sm', 'pop-md', 'pop-lg', 'pop-xl', 'switch-track-h', 'switch-track-w', 'switch-thumb', 'switch-on', 'switch-off', 'switch-lg-h', 'switch-lg-w', 'switch-lg-pad', 'switch-lg-knob', 'switch-lg-on'],
  shadow: ['card', 'pop'],
} } });
