...
export const zhCN = {
  ...
  'settings.followUp.queue.desc': '等待当前轮次结束后发送。',
  'settings.followUp.steer.desc': '将新消息加入当前轮次。agent 不支持时会加入队列。',
  'settings.followUp.interrupt.desc': '结束当前轮次，立即发送新消息。',
  ...
  'settings.followUp.desc': '选择 agent 工作时如何处理新消息。',
  ...
  'settings.agent.noSteer': '新消息加入队列',
  ...
  'settings.mcp.injected.desc': '选择供当前 agent 使用的 MCP 服务。新建会话后生效。',
  'settings.mcp.injected.none': '尚未添加 MCP 服务。',
  'settings.mcp.native': 'CLI 自带',
  'settings.mcp.native.desc': '来自 {agent} 的配置文件。点击路径打开编辑。',
  'settings.mcp.none': '没有 MCP 服务器',
  'settings.mcp.edit': '编辑配置',
  'settings.mcp.unsupported': '{agent} 不支持 {transport}，此服务不会启用。',
